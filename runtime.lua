...
function _G.map(f, x)
  ...
  local ____x4 = x
  local ____i14 = 0
  while ____i14 < _35(____x4) do
    local __v10 = ____x4[____i14 + 1]
    local __y4 = f(__v10)
    if is63(__y4) then
      add(__t2, __y4)
    end
...
function _G.mapcat(f, x, sep)
  ...
  local ____x5 = x
  local ____i16 = 0
  while ____i16 < _35(____x5) do
    local __v12 = ____x5[____i16 + 1]
    local __e3 = nil
    if f then
      __e3 = f(__v12)
    else
                  ...
                  if function63(x) then
                    ...
                    if stack and in63(x, stack) then
                      ...
                      if not( type(x) == "table") then
                        ...
                        local ____i30 = 0
                        while ____i30 < _35(____x25) do
                          local __v21 = ____x25[____i30 + 1]
                          __s = __s .. (__sp .. __v21)
                          __sp = " "
                          ____i30 = ____i30 + 1
                        end
                        local ____x26 = __ks
                        local ____i31 = 0
                        while ____i31 < _35(____x26) do
                          local ____id3 = ____x26[____i31 + 1]
