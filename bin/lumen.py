...
def numeric63(s=None):
  ...
  __i24 = 0
  while __i24 < __n22:
    if not number_code63(code(s, __i24)):
      return False
    __i24 = __i24 + 1
  return some63(s)
def tostring(x=None):
                ...
                if function63(x):
                  ...
                  if stack and in63(x, stack):
                    ...
                    if not( array63(x) or obj63(x)):
                      ...
                      ____x13 = __xs11
                      ____i27 = 0
                      while ____i27 < L_35(____x13):
                        __v15 = ____x13[____i27]
                        __s = cat(__s, __sp, __v15)
                        __sp = " "
                        ____i27 = ____i27 + 1
                      ____x14 = __ks
                      ____i28 = 0
                      while ____i28 < L_35(____x14):
                        ____id2 = ____x14[____i28]
                        __k13 = has(____id2, 0)
                        __v16 = has(____id2, 1)
                        __s = cat(__s, __sp, __k13, " ", __v16)
                        __sp = " "
                        ____i28 = ____i28 + 1
                      return cat(__s, ")")
...
def __f23(__x129=None, *_args, **_keys):
  ____id28 = __x129
...
def __f30(__x197=None, *_args, **_keys):
  ____id36 = __x197
