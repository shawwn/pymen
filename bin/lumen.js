...
find = function (f, t) {
  ...
  for (____i7 in ____o4) {
    var __x2 = ____o4[____i7];
    var __e6;
    if (numeric63(____i7)) {
      __e6 = parseInt(____i7);
    } else {
      __e6 = ____i7;
    }
    var ____i71 = __e6;
