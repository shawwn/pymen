...
setenv = function (k) {
  ...
  if (string63(__k31)) {
    ...
    if (has63(__keys, "toplevel")) {
      __e75 = hd(environment);
    } else {
      __e75 = last(environment);
    }
    var __frame = __e75;
    var __e76 = undefined;
...
setenv("with", {
  ...
  macro: function (x, v) {
    ...
    var __x115 = destash33(x, ____r120);
...
setenv("let-when", {
  ...
  macro: function (x, v) {
    ...
    var __x128 = destash33(x, ____r122);
...
setenv("define-reader", {
  ...
  macro: function (__x157) {
    ...
    var ____x157 = destash33(__x157, ____r130);
...
setenv("define", {
  ...
  macro: function (name, x) {
    ...
    var __x165 = destash33(x, ____r132);
...
setenv("define-global", {
  ...
  macro: function (name, x) {
    ...
    var __x171 = destash33(x, ____r134);
...
setenv("after", {
  ...
  macro: function (x) {
    ...
    var __x220 = destash33(x, ____r143);
    var ____id46 = ____r143;
    var __body27 = cut(____id46, 0);
    var __ok1 = unique("ok");
    var __r144 = unique("r");
    var ____x221 = object(["target", ["with", __r144, "nil", ["%block", "try", "||", ["set", __r144, __x220]], ["%block", "finally", "||", join(["%do"], __body27)]]]);
    ____x221.lua = join(["let", [[__ok1, __r144], ["guard", __x220]]], __body27, [["if", __ok1, __r144, ["throw", __r144]]]);
    return ____x221;
  }
});
setenv("with-frame", {
...
setenv("with-bindings", {
  ...
  macro: function (__x257) {
    ...
    var ____x257 = destash33(__x257, ____r146);
...
setenv("each", {
  ...
  macro: function (x, t) {
    ...
    var __x369 = destash33(x, ____r170);
    ...
    if (has(setenv("target", {
      ...
      __e82 = [join(["let", __k43, ["if", ["numeric?", __k43], ["parseInt", __k43], __k43]], __body43)];
    }
    return ["let", [__o23, __t4, __k43, "nil"], join(["%for", ____x375, __k43], props(__body43), [join(["let", [__v29, ["%get", __o23, __k43]]], __e82)])];
  }
});
setenv("for", {
  _stash: true,
...
setenv("%expand-case", {
  ...
  macro: function (x) {
    ...
    var __x655 = destash33(x, ____r226);
    ...
    return join(["%block", __a26], __e87, __body63);
  }
});
setenv("%cases", {
  _stash: true,
  macro: function () {
    ...
    if (none63(__args51)) {
      ...
      if (one63(__args51)) {
        ...
        var __r229 = unique("r");
        return join(["with", __r229, "nil"], map(function (__x673) {
          var ____id108 = __x673;
          var __x674 = has(____id108, 0);
          var __body65 = cut(____id108, 1);
          return ["%expand-case", __x674, ["%set", __r229, join(["%do"], __body65)]];
...
setenv("try", {
  ...
  macro: function (x) {
    ...
    var __x693 = destash33(x, ____r232);
...
var hex_prefix63 = function (_str) {
  ...
  var __i48 = __e89;
  var __id175 = code(_str, __i48) === 48;
  var __e90 = undefined;
  if (__id175) {
    __i48 = __i48 + 1;
    var __n36 = code(_str, __i48);
    __e90 = __n36 === 120 || __n36 === 88;
  } else {
    __e90 = __id175;
  }
  return __e90;
...
read_table[""] = function (s) {
  ...
  if (___str2 === "true") {
    ...
    if (___str2 === "false") {
      ...
      var __n37 = maybe_number(___str2);
      if (real63(__n37)) {
        return __n37;
      } else {
        return ___str2;
  ...
  if (string_starts63(s.string, "\"\"\"", s.pos)) {
    ...
    if (is63(__j1) && (__j1 < s.len && __b5 >= __j1)) {
      ...
      while (nil63(__r256)) {
        ...
        if (__c9 === "\"") {
          read_char(s);
          __r256 = clip(s.string, __i51, s.pos);
        } else {
          if (nil63(__c9)) {
            __r256 = expected(s, "\"");
          } else {
      ...
      if (hd(lh) === "t") {
        ...
        if (hd(lh) === "o") {
          ...
          for (__k49 in ____o30) {
            ...
            var __e95 = undefined;
            if (__k50 === "rest") {
              __e95 = ["cut", __id120, _35(lh)];
            } else {
              __e95 = ["has", __id120, ["quote", bias(__k50)]];
            }
            var __x723 = __e95;
            if (is63(__k50)) {
              var __e96 = undefined;
        ...
        if (atom63(__v36)) {
          ...
          if (hd(__v36) === "o") {
            ...
            if (hd(__v36) === "t") {
              ...
              __bs27 = join(__bs27, [__v36, __x754]);
            }
          }
        }
      }
...
var expand_definition = function (__x771) {
  ...
  try{
    ...
    for (____i60 in ____o33) {
      var ____x773 = ____o33[____i60];
      var __e99 = undefined;
      if (numeric63(____i60)) {
        __e99 = parseInt(____i60);
      } else {
        __e99 = ____i60;
      }
      var ____i601 = __e99;
...
var quasiquote_list = function (form, depth) {
  ...
  for (__k54 in ____o34) {
    ...
    if (! number63(__k55)) {
      ...
      if (quasisplice63(__v38, depth)) {
        __e101 = quasiexpand(__v38[1]);
      } else {
        __e101 = quasiexpand(__v38, depth);
      }
      var __v39 = __e101;
  ...
  var ____x782 = form;
  var ____i62 = 0;
  while (____i62 < _35(____x782)) {
    var __x783 = ____x782[____i62];
...
unique = function (x) {
  ...
  if (has63(__names8, __x795)) {
    var __i65 = __names8[__x795];
    __names8[__x795] = __names8[__x795] + 1;
    return unique(__x795 + __i65);
  } else {
    __names8[__x795] = 1;
    return "__" + __x795;
  }
...
compile_args = function (args, default63) {
  ...
  var ____x816 = args;
  var ____i69 = 0;
  while (____i69 < _35(____x816)) {
    var __x817 = ____x816[____i69];
...
var compile_call = function (form) {
  ...
  if (method_call63(hd(__args55))) {
    __e114 = mapcat(compile, __args55, "");
  } else {
    __e114 = compile_args(__args55);
  }
  var __args56 = __e114;
...
var op_delims = function (parent, child) {
  ...
  if (__e115(precedence(__child), precedence(__parent))) {
    return ["(", ")"];
  } else {
    return ["", ""];
  }
...
compile_function = function (args, body) {
  ...
  if (has(setenv("target", {
    ...
    if (has(setenv("target", {
      ...
      __e118 = join(__args57, ["|*_args|", "|**_keys|"]);
    } else {
      __e118 = __args57;
    }
    __e117 = __e118;
  }
  var __args141 = __e117;
...
compile = function (form) {
  var ____r336 = unstash(Array.prototype.slice.call(arguments, 1));
  var __form8 = destash33(form, ____r336);
  var ____id137 = ____r336;
  ...
  if (nil63(__form8)) {
    ...
    if (special_form63(__form8)) {
      ...
      if (atom63(__form8)) {
        __e124 = compile_atom(__form8);
      } else {
        var __e125 = undefined;
        if (infix63(hd(__form8))) {
          __e125 = compile_infix(__form8);
        } else {
          __e125 = compile_call(__form8);
        }
        __e124 = __e125;
      }
      var __form9 = __e124;
...
var lower_do = function (args, hoist, stmt63, tail63) {
  ...
  var ____i71 = 0;
  while (____i71 < _35(____x831)) {
    var __x832 = ____x831[____i71];
...
var lower_if = function (args, hoist, stmt63, tail63) {
  ...
  if (stmt63) {
    ...
    if (is63(___else)) {
      __e130 = [lower_body([___else], tail63)];
    }
    return add(hoist, join(["%if", lower(__cond6, hoist), lower_body([___then], tail63)], __e130));
  } else {
    var __e14 = unique("e");
    add(hoist, ["%local", __e14, "nil"]);
    var __e129 = undefined;
    if (is63(___else)) {
      __e129 = [lower(["%set", __e14, ___else])];
    }
    add(hoist, join(["%if", lower(__cond6, hoist), lower(["%set", __e14, ___then])], __e129));
    return __e14;
  }
};
var lower_short = function (x, args, hoist) {
  ...
  if (some63(__hoist1)) {
    ...
    if (x === "%and") {
      __e131 = ["%if", __id141, __b10, __id141];
    } else {
      __e131 = ["%if", __id141, __id141, __b10];
    }
    return lower(["%do", ["%local", __id141, __a31], __e131], hoist);
  } else {
...
var lower_while = function (args, hoist) {
  ...
  if (none63(__pre1)) {
    __e132 = ["%while", __c16, lower_body(__body77)];
  } else {
    __e132 = ["%while", true, join(["%do"], __pre1, [["%if", ["%not", __c16], ["%break"]], lower_body(__body77)])];
  }
  return add(hoist, __e132);
};
var lower_for = function (args, hoist) {
  var ____id143 = args;
  var __h = has(____id143, 0);
  var __k60 = has(____id143, 1);
  var __body78 = cut(____id143, 2);
  return add(hoist, join(["%for", lower(__h, hoist), __k60, lower_body(__body78)], props(__body78)));
};
var lower_with = function (args, hoist, stmt63, tail63) {
  ...
  if (stmt63 && ! tail63) {
    return add(hoist, join(["%with", lower(__h1, hoist), lower_body(__body79, tail63)], props(__body79)));
  } else {
    var __e15 = unique("e");
    add(hoist, ["%local", __e15]);
    add(hoist, join(["%with", lower(__h1, hoist), lower(["%set", __e15, join(["%do"], __body79)])], props(__body79)));
    return __e15;
  }
};
...
var lower_function = function (args, hoist) {
  if (has(setenv("target", {
    ...
    return join(["%function", __a32, lower_body(__body81, true)], props(__body81));
  }
};
var lower_definition = function (kind, args, hoist) {
  ...
  return add(hoist, join([kind, __name25, __args59, lower_body(__body82, true)], props(__body82)));
};
...
setenv("%do", {
  ...
  special: function () {
    ...
    var ____i73 = 0;
    while (____i73 < _35(____x880)) {
      var __x881 = ____x880[____i73];
      if (has(setenv("target", {
        _stash: true,
        toplevel: true
...
setenv("%try", {
  ...
  special: function (form) {
    ...
    if (has(setenv("target", {
      ...
      __e144 = ["%do", ["import", "sys"], ["%local", "e", [["%idx", "sys", "exc_info"]]], ["%return", ["%array", false, ["%get", "e", 1], "e"]]];
    } else {
      __e144 = ["%return", ["%array", false, "e"]];
    }
    var __hf1 = __e144;
    setenv("indent-level", {
      _stash: true,
...
setenv("%delete", {
  ...
  special: function (place) {
    ...
    return indentation() + (__e145 + compile(place));
  },
  stmt: true
});
setenv("%break", {
...
setenv("%error", {
  ...
  special: function (x) {
    ...
    if (has(setenv("target", {
      ...
      __e147 = "throw " + compile(["%new", ["Error", x]]);
    } else {
      ...
      if (has(setenv("target", {
        ...
        __e148 = "raise " + compile(["Exception", x]);
      } else {
        __e148 = "error(" + (compile(x) + ")");
      }
      __e147 = __e148;
    }
    var __e30 = __e147;
...
setenv("%object", {
  ...
  special: function () {
    ...
    for (__k72 in ____o41) {
      ...
      if (number63(__k73)) {
        var ____id164 = __v46;
        var __k74 = has(____id164, 0);
        var __v47 = has(____id164, 1);
        if (! string63(__k74)) {
          throw new Error("Illegal key: " + _str(__k74));
        }
        setenv("indent-level", {
          _stash: true,
          toplevel: true
        ...
        __s13 = __s13 + (__c20 + (key(__k74) + (__sep3 + ____x939)));
        __c20 = "," + either(__pad1, " ");
      }
    }
...
setenv("%list", {
  ...
  special: function (form, comps, cond) {
    ...
    var ____x941 = comps;
    var ____i79 = 0;
    while (____i79 < _35(____x941)) {
      var ____id166 = ____x941[____i79];
      var __k76 = has(____id166, 0);
      var __v49 = has(____id166, 1);
