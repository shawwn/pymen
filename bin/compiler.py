...
def lower_do(args=None, hoist=None, stmt63=None, tail63=None):
  ...
  ____i17 = 0
  while ____i17 < _35(____x100):
    __x101 = ____x100[____i17]
...
def __f9(*_rest, **_params):
  ...
  while ____i19 < _35(____x144):
    __x145 = ____x144[____i19]
    if setenv("target", {"_stash": True, "toplevel": True})["value"] == "lua" and immediate_call63(__x145) and "\n" == char(__s4, edge(__s4)):
      __s4 = cat(clip(__s4, 0, edge(__s4)), ";\n")
    __s4 = cat(__s4, compile(__x145, {"_stash": True, "stmt": True}))
    if not atom63(__x145):
      if hd(__x145) == "return" or hd(__x145) == "break":
        break
    ____i19 = ____i19 + 1
  return __s4
...
def __f13(form=None):
  ...
  setenv("indent-level", {"_stash": True, "toplevel": True})["value"] = setenv("indent-level", {"_stash": True, "toplevel": True})["value"] + 1
  ____x155 = compile(__hf1, {"_stash": True, "stmt": True})
  setenv("indent-level", {"_stash": True, "toplevel": True})["value"] = setenv("indent-level", {"_stash": True, "toplevel": True})["value"] - 1
  __h1 = ____x155
...
def __f17(name=None, args=None, body=None):
  if setenv("target", {"_stash": True, "toplevel": True})["value"] == "lua" or setenv("target", {"_stash": True, "toplevel": True})["value"] == "py":
    __x159 = compile_function(args, body, {"_stash": True, "name": name})
...
def __f18(name=None, args=None, body=None):
  if setenv("target", {"_stash": True, "toplevel": True})["value"] == "lua" or setenv("target", {"_stash": True, "toplevel": True})["value"] == "py":
    __x165 = compile_function(args, body, {"_stash": True, "name": name, "prefix": "local"})
