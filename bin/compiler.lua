...
local function expand_local(__x59)
  local ____id6 = __x59
  local __x60 = has(____id6, 1)
...
local function expand_function(__x62)
  local ____id7 = __x62
  local __x63 = has(____id7, 1)
...
local function expand_definition(__x69)
  local ____id9 = __x69
  local __x70 = has(____id9, 1)
  ...
  local ____id10 = {xpcall(function ()
    ...
    for ____i8 in next, ____o6 do
      local ____x71 = ____o6[____i8]
      setenv(____x71, {
        _stash = true,
        variable = true
      })
    end
    return join({__x70, __name1, __args3}, macroexpand(__body2))
  end, function (m)
    if obj63(m) then
      return m
    else
...
function expand1(__x76)
  local ____id11 = __x76
    ...
    if symbol63(form) then
      ...
      if atom63(form) then
        ...
        if __x79 == "%local" then
          ...
          if __x79 == "%function" then
            return expand_function(form)
          else
            if __x79 == "%global-function" then
              return expand_definition(form)
            else
              if __x79 == "%local-function" then
                return expand_definition(form)
              else
                if __x79 == "%expansion" then
                  return form[2]
                else
                  if macro63(__x79) then
                    return expand_macro(form)
                  else
                    if parse_access63(__x79) then
                      return macroexpand(join({parse_access(__x79)}, tl(form)))
                    else
...
local function quasiquote_list(form, depth)
  ...
  for __k6 in next, ____o7 do
    ...
    if not number63(__k6) then
      ...
      if quasisplice63(__v6, depth) then
        __e54 = quasiexpand(__v6[2])
      else
        __e54 = quasiexpand(__v6, depth)
      end
      local __v7 = __e54
      last(__xs)[__k6] = __v7
    end
  ...
  local ____x83 = form
  local ____i10 = 0
  while ____i10 < _35(____x83) do
    local __x84 = ____x83[____i10 + 1]
...
function expand_if(__x89)
  local ____id12 = __x89
...
local __names = {}
function unique(x)
  local __x96 = compile_id(x)
  if has63(__names, __x96) then
    local __i13 = __names[__x96]
    __names[__x96] = __names[__x96] + 1
    return unique(__x96 .. __i13)
  else
    __names[__x96] = 1
    return "__" .. __x96
  end
...
____x106.cmake = "LESS"
____x106.all = "<"
____x105["%lt"] = ____x106
local ____x107 = object({})
____x107.cmake = "GREATER"
____x107.all = ">"
____x105["%gt"] = ____x107
local ____x108 = object({})
____x108.cmake = "LESS_EQUAL"
____x108.all = "<="
____x105["%le"] = ____x108
local ____x109 = object({})
____x109.cmake = "GREATER_EQUAL"
____x109.all = ">="
____x105["%ge"] = ____x109
local ____x110 = object({})
local ____x111 = object({})
____x111.js = "==="
____x111.lua = "=="
____x111.py = "=="
____x110["%eq"] = ____x111
local ____x112 = object({})
local ____x113 = object({})
____x113.py = "in"
____x112["%in"] = ____x113
local ____x114 = object({})
____x114.py = "is"
____x112["%is"] = ____x114
...
local infix = {____x99, ____x101, ____x102, ____x104, ____x105, ____x110, ____x112, ____x115, ____x117}
    ...
    return find(function (level)
      ...
      if __x120 == true then
        ...
        if string63(__x120) then
          ...
          if is63(__x120) then
            return has(__x120, has(setenv("target", {
              _stash = true,
              toplevel = true
            }), "value")) or has(__x120, "all")
          end
        end
      end
    end, infix)
...
function compile_args(args, default63)
  ...
  while ____i17 < _35(____x121) do
    ...
    if (has(setenv("target", {
      ...
      _stash = true,
      toplevel = true
    }), "value") == "cmake") and (default63 and (not id_literal63(__x122) and not( __x122 == "..."))) then
      local __e62 = nil
      if has(setenv("target", {
        _stash = true,
        toplevel = true
...
local function compile_call(form)
  ...
  if method_call63(hd(__args7)) then
    __e68 = mapcat(compile, __args7, "")
  else
    __e68 = compile_args(__args7)
  end
  local __args8 = __e68
...
local function op_delims(parent, child, ...)
  ...
  if __e69(precedence(__child), precedence(__parent)) then
    return {"(", ")"}
  else
    return {"", ""}
  end
...
function compile_function(args, body, ...)
  ...
  local __args12 = __e71
  local __e72 = nil
  if has(setenv("target", {
    _stash = true,
    toplevel = true
  }), "value") == "cmake" then
    __e72 = compile_args(join({{"%literal", __id21}}, __args12), true)
  else
    __e72 = compile_args(__args12, true)
  end
  local __args10 = __e72
  ...
  if nil63(__form) then
    ...
    if special_form63(__form) then
      ...
      if atom63(__form) then
        __e79 = compile_atom(__form, __raw63)
      else
        local __e80 = nil
        if infix63(hd(__form)) then
          __e80 = compile_infix(__form)
        else
          __e80 = compile_call(__form)
        end
        __e79 = __e80
      end
      local __form1 = __e79
...
local function lower_do(args, hoist, stmt63, tail63)
  local ____x140 = almost(args)
  local ____i19 = 0
  while ____i19 < _35(____x140) do
    local __x141 = ____x140[____i19 + 1]
    local ____y = lower(__x141, hoist, stmt63)
    if yes(____y) then
      local __e1 = ____y
...
local function lower_if(args, hoist, stmt63, tail63)
  ...
  if stmt63 then
    ...
    if is63(___else) then
      __e85 = {lower_body({___else}, tail63)}
    end
    return add(hoist, join({"%if", lower(__cond, hoist), lower_body({___then}, tail63)}, __e85))
  else
    local __e3 = unique("e")
    add(hoist, {"%local", __e3, "nil"})
    local __e84 = nil
    if is63(___else) then
      __e84 = {lower({"%set", __e3, ___else})}
    end
    add(hoist, join({"%if", lower(__cond, hoist), lower({"%set", __e3, ___then})}, __e84))
    if has(setenv("target", {
      _stash = true,
      toplevel = true
    }), "value") == "cmake" then
...
local function lower_short(x, args, hoist)
  ...
  if some63(__hoist1) then
    ...
    local __e86 = nil
    if x == "%and" then
      __e86 = {"%if", __id26, __b4, __id26}
    else
      __e86 = {"%if", __id26, __id26, __b4}
    end
    return lower({"%do", {"%local", __id26, __a4}, __e86}, hoist)
  else
...
local function lower_while(args, hoist)
  ...
  if none63(__pre1) then
    __e87 = {"%while", __c5, lower_body(__body6)}
  else
    __e87 = {"%while", true, join({"%do"}, __pre1, {{"%if", {"%not", __c5}, {"%break"}}, lower_body(__body6)})}
  end
  return add(hoist, __e87)
end
...
local function lower_import(__x175, hoist, stmt63, tail63)
  local ____id33 = __x175
                    ...
                    if __x188 == "%while" then
                      ...
                      if __x188 == "%for" then
                        ...
                        if __x188 == "%with" then
                          ...
                          if __x188 == "%block" then
                            return lower_block("%block", __args14, hoist, stmt63, tail63)
                          else
                            if __x188 == "%cases" then
                              return lower_cases(__args14, hoist, stmt63, tail63)
                            else
                              if __x188 == "import" then
                                return lower_import(__args14, hoist, stmt63, tail63)
                              else
                                if __x188 == "from" then
                                  return lower_from(__args14, hoist, stmt63, tail63)
                                else
                                  if __x188 == "%function" then
                                    return lower_function(__args14, hoist)
                                  else
                                    if __x188 == "%local-function" or __x188 == "%global-function" then
                                      return lower_definition(__x188, __args14, hoist)
                                    else
                                      if in63(__x188, {"%and", "%or"}) then
                                        return lower_short(__x188, __args14, hoist)
                                      else
                                        if statement63(__x188) then
...
local function ___37do__special(...)
  ...
  local __s4 = ""
  local ____x195 = __forms2
  local ____i21 = 0
  while ____i21 < _35(____x195) do
    local __x196 = ____x195[____i21 + 1]
    if has(setenv("target", {
      _stash = true,
      toplevel = true
    }), "value") == "lua" and (immediate_call63(__x196) and "\n" == char(__s4, edge(__s4))) then
      __s4 = clip(__s4, 0, edge(__s4)) .. ";\n"
    end
    __s4 = __s4 .. compile(__x196, {
      _stash = true,
      stmt = true
    })
    if not atom63(__x196) then
      if hd(__x196) == "%return" or hd(__x196) == "%break" then
        break
      end
    end
    ____i21 = ____i21 + 1
...
local function ___37try__special(form)
  ...
  if has(setenv("target", {
    ...
    __e95 = {"%do", {"import", "sys"}, {"%local", "e", {{"%idx", "sys", "exc_info"}}}, {"%return", {"%array", false, {"%get", "e", 1}, "e"}}}
  else
    __e95 = {"%return", {"%array", false, "e"}}
  end
  local __hf1 = __e95
  setenv("indent-level", {
    _stash = true,
...
local function ___37delete__special(place)
  ...
  return indentation() .. (__e96 .. compile(place))
end
setenv("%delete", {
  _stash = true,
...
local function ___37break__special()
  ...
  return indentation() .. ("break" .. __e97)
end
setenv("%break", {
  _stash = true,
...
local function ___37global_function__special(name, args, ...)
  ...
  if has(setenv("target", {
    ...
    local ____x237 = object({__args18})
    ____x237.name = __name9
    local ____x238 = object({})
    ____x238.name = __name9
    local __x236 = apply(compile_function, join(____x237, __body25, ____x238))
...
local function ___37local_function__special(name, args, ...)
  ...
  if has(setenv("target", {
    ...
    local ____x249 = object({__args20})
    ____x249.name = __name11
    ____x249.prefix = "local"
    local ____x250 = object({})
    ____x250.name = __name11
    ____x250.prefix = "local"
    local __x248 = apply(compile_function, join(____x249, __body27, ____x250))
...
local function ___37return__special(x)
  ...
  if has(setenv("target", {
    ...
    if nil63(x) then
      ...
      __e100 = {"return", "PROPAGATE", x}
    end
    __e98 = compile(__e100)
  else
    local __e99 = nil
    if nil63(x) then
      __e99 = "return"
    else
      __e99 = "return " .. compile(x)
    end
    __e98 = __e99
  end
  return indentation() .. __e98
end
setenv("%return", {
  _stash = true,
...
local function ___37error__special(x)
  ...
  if has(setenv("target", {
    ...
    __e101 = "throw " .. compile({"%new", {"Error", x}})
  else
    local __e102 = nil
    if has(setenv("target", {
      _stash = true,
      ...
      __e102 = "raise " .. compile({"Exception", x})
    else
...
local function ___37throw__special(x)
  ...
  if has(setenv("target", {
    ...
    if has(setenv("target", {
      ...
      __e104 = "raise " .. compile(x)
    else
      __e104 = "error(" .. (compile(x) .. ")")
    end
    __e103 = __e104
  end
  local __e26 = __e103
...
local function ___37object__special(...)
  ...
  local ____x275 = pair(__forms6)
  local ____i25 = 0
  while ____i25 < _35(____x275) do
    local ____id53 = ____x275[____i25 + 1]
    ...
    __s12 = __s12 .. (__c9 .. (key(__k18) .. (__sep3 .. ____x276)))
    local __e116 = nil
    if has(setenv("target", {
      _stash = true,
      toplevel = true
...
local function ___37list__special(form, comps, cond, ...)
  ...
  local ____id58 = __e118
  local __lh6 = has(____id58, 1)
  local __rh8 = has(____id58, 2)
  if not( __kind1 == "object") then
    __s14 = "(" .. (__s14 .. ")")
  end
  local ____x284 = __comps1
  local ____i27 = 0
  while ____i27 < _35(____x284) do
    local ____id59 = ____x284[____i27 + 1]
...
local function __from__special(name, ...)
  ...
  if hd(__imports1) == "import" then
    __e121 = tl(__imports1)
  else
    __e121 = __imports1
  end
  local __names3 = __e121
