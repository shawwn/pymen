...
local function op_delims(parent, child, ...)
  ...
  if __e44(precedence(__child), precedence(__parent)) then
    return {"(", ")"}
  else
    return {"", ""}
  end
